...
//		return organization;
		Optional<Organization> organization = repository.findById(id);
		organization.get().setDepartments(departmentClient.findByOrganizationWithEmployees(organization.get().getId()));
		return organization.get();
	}
...
//		return organization;
		Optional<Organization> organization = repository.findById(id);
		organization.get().setEmployees(employeeClient.findByOrganization(organization.get().getId()));
		return organization.get();
	}
...
//		return organization;
		Optional<Organization> organization = repository.findById(id);
		organization.get().setEmployees(new ArrayList<>());
		return organization.get();
	}
